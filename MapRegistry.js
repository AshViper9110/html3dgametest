class MapRegistry {
  ...
  _build() {
    this._add('grid', {
      name: 'Grid',
      desc: 'Open training arena with a speed pad',
    ...
    this._add('maze', {
      name: 'Maze',
      desc: 'Navigate tight corridors and ambush opponents',
    ...
    this._add('colloseum', {
      name: 'Colloseum',
      desc: 'Compact arena with pillar cover',
    ...
    this._add('abyss', {
      name: 'Abyss',
      desc: 'Deadly central vortex with watchtowers',
    ...
    this._add('fort', {
      name: 'Fort',
      desc: 'Fortified stronghold with defensive positions',
    ...
    this._add('chaos', {
      name: 'Chaos',
      desc: 'Dense obstacle field with a central boost pad',
    ...
    this._add('reactor', {
      name: 'Reactor',
      desc: 'Glowing core chamber with speed boost',
    ...
    this._add('ice', {
      name: 'Ice',
      desc: 'Slippery frozen tundra with teleport pad',
    ...
    this._add('dojo', {
      name: 'Dojo',
      desc: 'Symmetrical battle arena with jump pads',
    ...
    this._add('twilight', {
      name: 'Twilight',
      desc: 'Low visibility neon haze maze',
